...
### Test Coverage
- **331 unit tests** declared (327 executable tests + 4 benchmark wrappers), with wasm-gc/js passing locally and native covered by CI
...
native requires a C compiler and is covered by CI. Codebase is 12464
effective MoonBit lines (implementation 5448 + tests 7016); the implementation
