...
截至 2026-07-06 Asia/Shanghai，native/wasm-gc/js 本地测试基线全绿；native 已在 Windows 的 MSVC 19.44 + Windows SDK 10.0.26100.0 环境验证。代码库共 13485 有效 MoonBit 行（实现 5436 + 测试 8049），实现规模仍处于竞赛 4-10k 区间内。
