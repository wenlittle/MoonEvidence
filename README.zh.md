...
- **288 个单元测试**在 native / wasm-gc / js 三后端全绿；NIST SHA-256/512 向量、RFC 8785 Appendix B 向量全过
...
所有命令于 2026-07-05 Asia/Shanghai 本地通过。代码库共 11070 有效 MoonBit 行（实现 5294 + 测试 5776），处于竞赛 4-10k 区间内。
