...
| `docs/BRANCH_COVERAGE.md` | Manual branch coverage audit for security-relevant accept/reject/skip/warn paths; current pass covers verify/incremental/merkle/digest/crypto/create/store/audit |
