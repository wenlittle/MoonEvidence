...
| Showcase | 沉浸首页、六工具工作台、实链记录页和真实 MoonBit JS 产物 | [`showcase/`](../showcase/) |
...
| 复跑 Fabric | [Fabric 指南](../integrations/fabric/README.md) -> [锚定规范](spec/FABRIC_ANCHOR_SPEC.md) -> [发布实链记录](records/fabric-e2e/2026-07-12-v0.5.1/) |
...
| [`records/fabric-e2e/2026-07-12-v0.5.1/`](records/fabric-e2e/2026-07-12-v0.5.1/) | `v0.5.1` 发布制品、Fabric 部署、交易、查询和摘要回传证据 |
...
| Fabric 交易结论 | `records/fabric-e2e/2026-07-12-v0.5.1/` |
| 仓库社交预览 | `images/social-preview.png` |
...
| 项目 | 状态 |
| --- | --- |
| MoonEvidence v0.5.1 | GitHub Release、GitLink tag 和 Mooncakes 已发布 |
