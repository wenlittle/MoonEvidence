...
| 层次 | 名称 | 现状 | 目标 | 优先级 |
|---|---|---|---|---|
| L0 | 单元测试（白盒） | 344个声明（340可执行+4基准wrapper）+ verify/incremental/merkle/digest/crypto/create/store/audit 分支图 | 增加 stale-check gate 防漂移 | P0/P1 |
