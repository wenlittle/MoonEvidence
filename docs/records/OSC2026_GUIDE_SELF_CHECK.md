...
| Runnable behavior | Pass | JS/native CLI suites passed 62/62 each; browser API smoke passed 36/36; Showcase production build passed; Gateway passed 19/19; clean Mooncakes consumer passed 2/2 |
...
| PowerShell CLI black box, JS and native | Pass: 62/62 per target |
| Browser adapter and Showcase | API smoke 36/36; TypeScript check and production build pass |
