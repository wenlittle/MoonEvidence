...
const timeline = [
  ...
  { icon: Blocks, step: "03", title: "区块确认", text: "交易进入区块 14，验证状态为 VALID，原始交易标识被固定。" },
    ...
    <div className="ledger-page">
      <section className="ledger-hero" aria-labelledby="ledger-title">
        ...
        <div className="ledger-route" aria-label="Fabric 交易路径">
          ...
          <div className="ledger-route-node node-block"><Blocks /><span>区块 14</span><strong>VALID</strong></div>
